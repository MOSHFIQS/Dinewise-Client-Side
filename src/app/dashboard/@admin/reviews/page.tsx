...
export default async function AdminReviewsPage() {
     ...
     if (!res.success) {
          return (
               <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
                    <p className="text-rose-500 font-bold uppercase tracking-widest text-xs">Failed to load platform reviews</p>
     ...
     return (
          <div className="space-y-8 animate-in fade-in duration-500 pb-12">
               <div>
                    <h1 className="text-4xl font-black tracking-tight text-slate-900">Platform Feedback</h1>
                    <p className="text-muted-foreground text-lg">Monitor and moderate reviews across the entire DineWise platform.</p>
               </div>
               ...
               {reviews.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 bg-white/50 backdrop-blur-sm rounded-[3rem] border border-dashed border-slate-200">
                         ...
                         <p className="text-slate-500 font-medium text-lg">No reviews have been posted yet.</p>
                    </div>
               ) : (
